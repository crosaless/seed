...
/**
 * Clase que realiza la operación de resta de dos números enteros. Esta clase es final para evitar que sea extendida.
 */
public final class Resta {
     ...
     *
     * @param minuendo
     *            el primer número entero (minuendo).
     * @param sustraendo
     *            el segundo número entero (sustraendo).
     * 
