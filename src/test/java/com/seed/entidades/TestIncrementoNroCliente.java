...
public class TestIncrementoNroCliente {
    ...
    public void testIncrementoNroCliente() {
        ...
        // Act
        Cliente cliente1 = new Cliente(nombreCliente, apellidoCliente, fechaNacimiento, dniCliente, nroCelular,
                emailCliente);
        Cliente cliente2 = new Cliente(nombreCliente2, apellidoCliente2, fechaNacimiento2, dniCliente2, nroCelular2,
                emailCliente2);
